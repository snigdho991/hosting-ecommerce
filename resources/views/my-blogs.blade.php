    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="page-title">My Own Blogs</div>
            </div>
        </div>
    </div>
</div>

@if($featured_blog->count() > 0)
            ...
            <div class="row">
    	        	...
    	        	@foreach($featured_blog as $single_featured)
    	                ...
    	                <div class="article-summary">
    	                    ...
    	                    <div class="article-text">{!! \Illuminate\Support\Str::limit($single_featured->content, 120, '...') !!} 
    	                    </div>
...
<div id="articles" class="container-fluid">
    <div class="container">
        <div class="row">
            ...
            @else
                <div class="alert alert-danger">No Blog Post Found !</div>
            @endif
        </div>  
    </div>
</div>
