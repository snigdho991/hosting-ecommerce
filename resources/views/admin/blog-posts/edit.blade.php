    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('blog.update.post', ['slug' => $post->slug ]) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" cols="8" rows="12" class="form-control @error('content') is-invalid @enderror">{{ $post->content }}</textarea>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="featured">Current Image </label>
                            <br><img src="{{ asset('/'.$post->featured) }}" alt="" style="height: 230px; width: 300px;">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="featured">Change Image </label>
                            ...
                            <select name="category_id" id="category" class="form-control @error('category_id') is-invalid @enderror">
                                @foreach($blog_categories as $blog_category)
                                    <option value="{{ $blog_category->id }}"
                                        @if($blog_category->id == $post->category_id)
                                            selected="" 
                                        @endif
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            @foreach($blog_tags as $blog_tag)
                                <div class="checkbox">
                                    <label><input type="checkbox" name="tags[]" style="cursor: pointer;" value="{{ $blog_tag->id }}"
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input type="radio" name="is_homepage" id="is_homepage" value="0"
                                @if($post->is_homepage == 0)
                                    checked="" 
                                @endif /> General
                            <br><input type="radio" name="is_homepage" id="is_homepage" value="1" 
