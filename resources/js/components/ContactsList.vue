        ...
        <ul>
            ...
            <span v-else-if="!dataContacts.length">
                <li v-for="contact in sortedContacts" :key="contact.id" @click="selectContact(contact)" :class="{ 'selected': contact == selected }">
                    ...
                    <div class="contact">
                        <p class="name" style="font-size:14px !important;">{{ contact.first_name + '  ' + contact.last_name }}</p>
            ...
            <span v-else>
                <li v-for="contact in dataContacts" :key="contact.id" @click="selectContact(contact)" :class="{ 'selected': contact == selected }">
                    <div class="avatar">
                        <img :src="'http://via.placeholder.com/150'" :alt="contact.name">
                    </div>
                    <div class="contact">
